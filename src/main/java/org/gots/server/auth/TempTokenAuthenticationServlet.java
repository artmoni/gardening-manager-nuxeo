...
import org.gots.server.auth.service.TokenAuthenticationService;
 ...
 * @since 5.7
 */
public class TempTokenAuthenticationServlet extends HttpServlet {

    private static final long serialVersionUID = 7792388601558509103L;

    private static final Log log = LogFactory.getLog(TempTokenAuthenticationServlet.class);
